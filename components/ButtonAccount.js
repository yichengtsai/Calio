...
//
// Billing (Stripe Customer Portal) is hidden for now since Stripe isn't set up yet.
// To bring it back: restore the "Billing" button + handleBilling function
// and the apiClient import.
